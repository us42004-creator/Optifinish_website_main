        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              ...
              <a href="https://www.instagram.com/vacspl" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-7 w-7 items-center justify-center rounded-full border border-white/[0.1] text-white/30 transition hover:border-white/30 hover:text-white/70">
              ...
              <a href="https://www.facebook.com/optifinish.connect" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-7 w-7 items-center justify-center rounded-full border border-white/[0.1] text-white/30 transition hover:border-white/30 hover:text-white/70">
