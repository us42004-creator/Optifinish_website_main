      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:grid-cols-4">
          ...
          <div className="pb-6 border-b border-white/[0.06] lg:border-b-0 lg:pb-0">
            ...
            <span className="mt-3 block text-[9px] font-semibold uppercase tracking-[0.22em] text-white/38">Industrial Coating Solutions</span>
            <span className="mt-1 block text-[8px] font-semibold uppercase tracking-[0.18em] text-white/22">
              Value Added Coating Solutions Pvt. Ltd.
            </span>
            <div className="mt-5 space-y-1">
              <p className="text-[9px] text-white/30">+91-96434-03374</p>
              <p className="text-[9px] text-white/30">info@optifinish.in</p>
              <p className="text-[9px] text-white/30">Greater Noida, UP — 201306</p>
            </div>
            <div className="mt-4 flex gap-3">
              <a href="https://www.linkedin.com/company/value-added-coating-solution" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex h-11 w-11 items-center justify-center rounded-full border border-white/[0.1] text-white/30 transition hover:border-white/30 hover:text-white/70 sm:h-7 sm:w-7">
              ...
              <a href="https://www.youtube.com/@vacspl" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="flex h-11 w-11 items-center justify-center rounded-full border border-white/[0.1] text-white/30 transition hover:border-white/30 hover:text-white/70 sm:h-7 sm:w-7">
              ...
              <a href="https://www.instagram.com/vacspl" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-11 w-11 items-center justify-center rounded-full border border-white/[0.1] text-white/30 transition hover:border-white/30 hover:text-white/70 sm:h-7 sm:w-7">
              ...
              <a href="https://www.facebook.com/optifinish.connect" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-11 w-11 items-center justify-center rounded-full border border-white/[0.1] text-white/30 transition hover:border-white/30 hover:text-white/70 sm:h-7 sm:w-7">
