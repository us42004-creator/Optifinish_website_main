...
export const SITE = {
  ...
  tagline:     'Your one step coating automation solution',
  description: 'OptiFinish (Value Added Coating Solutions Pvt. Ltd.) manufactures powder coating plants, curing ovens, spray booths, and proprietary automation systems — including the Z-TAP robot and ZA01 reciprocator. Authorised GEMA and DÜRR partner in India.',
...
export const organizationSchema = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Powder Coating Plant' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Curing Oven' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Z-TAP Coating Automation System' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'ZA01 Automatic Reciprocator' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'GEMA Manual Powder Coating Gun' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'GEMA Automatic Powder Coating Gun' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'GEMA OptiCentre Powder Management' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'DÜRR Liquid Coating Systems' } },
    ],
  },
};
