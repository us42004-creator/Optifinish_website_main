...
export const organizationSchema = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Powder Coating Plant', offers: { '@type': 'Offer', url: `${SITE.url}/products/optifinish-manufactured/powder-coating-plant`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Curing Oven', offers: { '@type': 'Offer', url: `${SITE.url}/products/optifinish-manufactured/curing-oven`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Z-TAP Coating Automation System', offers: { '@type': 'Offer', url: `${SITE.url}/products/automation/z-tap`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'ZA01 Automatic Reciprocator', offers: { '@type': 'Offer', url: `${SITE.url}/products/automation/za01`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'GEMA Manual Powder Coating Gun', offers: { '@type': 'Offer', url: `${SITE.url}/products/gema/manual-gun`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'GEMA Automatic Powder Coating Gun', offers: { '@type': 'Offer', url: `${SITE.url}/products/gema/automatic-gun`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'GEMA OptiCentre Powder Management', offers: { '@type': 'Offer', url: `${SITE.url}/products/gema/opticentre`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'DÜRR Liquid Coating Systems', offers: { '@type': 'Offer', url: `${SITE.url}/products/durr`, priceCurrency: 'INR', availability: 'https://schema.org/InStock' } } },
    ],
  },
};
