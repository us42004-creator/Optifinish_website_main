...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      // Old sitelinks still indexed by Google → redirect to correct new pages
      { source: '/support',                          destination: '/services',                                    permanent: true },
      { source: '/support/:path*',                   destination: '/services',                                    permanent: true },
      { source: '/powder-coating-plant-india',       destination: '/products/optifinish-manufactured/powder-coating-plant', permanent: true },
      { source: '/powder-coating-plant-in-india',    destination: '/products/optifinish-manufactured/powder-coating-plant', permanent: true },
      { source: '/components-finish',                destination: '/our-work',                                    permanent: true },
      { source: '/components-coating',               destination: '/our-work',                                    permanent: true },
      { source: '/powder-coating-plant',             destination: '/products/optifinish-manufactured/powder-coating-plant', permanent: true },
      { source: '/curing-oven',                      destination: '/products/optifinish-manufactured/curing-oven', permanent: true },
      { source: '/spray-booth',                      destination: '/products/optifinish-manufactured/powder-spray-booth', permanent: true },
      { source: '/pretreatment-line',                destination: '/products/optifinish-manufactured/pt-line',   permanent: true },
      { source: '/pt-line',                          destination: '/products/optifinish-manufactured/pt-line',   permanent: true },
      { source: '/gema',                             destination: '/products/gema',                              permanent: true },
      { source: '/gema/:path*',                      destination: '/products/gema',                              permanent: true },
      { source: '/automation',                       destination: '/products/automation',                        permanent: true },
      { source: '/z-tap',                            destination: '/products/automation/z-tap',                  permanent: true },
      { source: '/our-clients',                      destination: '/our-work',                                    permanent: true },
      { source: '/clients',                          destination: '/our-work',                                    permanent: true },
