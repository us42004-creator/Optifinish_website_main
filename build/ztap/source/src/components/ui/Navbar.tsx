...
const NAV_LINKS = [
  { href: '#demo-video', label: 'Live Demo' },
  { href: '#zero-touch', label: 'How It Works' },
  { href: '#end-to-end', label: 'Complete Line' },
  { href: '#line-impact', label: 'Results' },
...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      links,
      { x: -48, opacity: 0 },
      { x: 0, opacity: 1, stagger: 0.055, duration: 0.5, ease: 'power3.out', delay: 0.1 }
    );
    if (cta) {
      gsap.fromTo(cta, { y: 24, opacity: 0 }, { y: 0, opacity: 1, duration: 0.5, ease: 'power3.out', delay: 0.42 });
    }
  }, [menuOpen]);
      ...
      >
        <div className="flex justify-center px-3 pt-2.5 md:px-4 md:pt-4">
          ...
          >
            ...
            >
              <a href="#" onClick={(e) => scrollTo(e, '#')} className="flex min-w-0 items-center self-center group">
                <Image
                  src="/logo.png"
                  alt="OptiFinish"
                  width={192}
              ...
              <div className="flex shrink-0 items-center gap-2.5">
                <a
                  ...
                  className={`hidden rounded-full border border-yellow/20 bg-yellow font-bold uppercase tracking-[0.2em] text-ink lg:flex ${scrolled && !expanded ? 'px-4 py-1.5 text-[8px]' : 'px-5 py-2 text-[9px]'} transition-all duration-300`}
                >
                ...
                <button
                  className={`flex h-9 w-9 items-center justify-center rounded-full transition-colors hover:border-yellow/40 hover:text-yellow lg:hidden ${
                    scrolled ? 'border border-white/18 bg-white/[0.06] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]' : 'border border-black/12 bg-white/[0.42] text-black shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]'
                  }`}
        ...
        {menuOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 pt-4">
              <a href="#" onClick={(e) => scrollTo(e, '#')} className="flex items-center">
                <Image
                  src="/logo.png"
                  alt="OptiFinish"
                  width={192}
            ...
            {/* Nav links — Apple-style large display type */}
